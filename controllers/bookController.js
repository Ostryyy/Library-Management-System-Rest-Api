...
const updateBook = [
  ...
  body('available_copies').optional().isInt({ min: 0 }).withMessage('Available copies must be a positive integer'),
...
module.exports = { addBook, getAllBooks, deleteBook, updateBook, searchBooks };
